...
public final class LibraryManager {
	...
	public static void initLibraryPath() {
		...
		System.setProperty("jna.library.path", String.format("%s%s%s", System.getProperty("jna.library.path"), Utils.PATH_SEPARATOR, path.toString()));
		System.setProperty("java.library.path", String.format("%s%s%s", System.getProperty("java.library.path"), Utils.PATH_SEPARATOR, path.toString()));
		try {
